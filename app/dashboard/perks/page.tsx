...
const ALL_ATOMIC_PERKS: AtomicPerk[] = [
  // --- BANKING CASH & REWARDS (SEPARATE ATOMIC CARDS) ---
  {
    ...
    description: "Open a new Preferred Package for Students and Youth with $0 monthly fee and complete qualifying transactions to get $200 cash deposited directly. Offer ends November 1, 2026.",
    keyPoints: ["$200 Cash Welcome Bonus (Ends Nov 1, 2026)", "$0 Monthly Account Fee", "Closest branch network to UW, UofT & UBC gates"],
  ...
  },
  {
    ...
    keyPoints: ["Free Apple AirPods 4 (Ends Nov 2, 2026)", "Avion Points rewards on debit purchases", "NOMI AI automated spending insights"],
  ...
  },
  {
    ...
    description: "Prefer cash over headphones? Choose the instant $100 cash deposit alternative. Canada's largest branch network with locations in every major student town.",
  ...
  },
  {
    ...
    keyPoints: ["$175 Cash Reward for new student accounts", "$0 monthly fee while enrolled", "Free international wire transfers ($0 fee)"],
    ctaLabel: "Claim $175 with CIBC",
    ctaLink: "https://www.cibc.com/en/student/bank-accounts.html?ref=passportperk",
    valueDollars: 175,
    badgeTag: "Top Cash Reward",
    regionSpecific: "All",
  },
  {
    id: "td-150-cash",
    ...
    keyPoints: ["Up to $150 cash offer (Valid until Nov 2, 2026)", "Open 7 days a week (late evenings & Sundays)", "$0 monthly student chequing fee"],
